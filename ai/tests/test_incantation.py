...
class TestIncantation(unittest.TestCase):
    ...
    def test_incantation_success(self):
        ...
        self.mock_connection.receive_line.side_effect = ["Elevation underway", "Current level: 2"]
